...
method.type <- "HYFIS"
control <- list(num.labels = 5, max.iter = 50, step.size = 0.01, type.tnorm = "MIN", type.snorm = "MAX", type.defuz = "LAST.MAX", type.implication.func = "ZADEH", name = "Traffic-HyFIS")
...
#    names.varoutput =  c("Muito Rapido", "Rapido", "Tempo Medio", "Demorado", "Muito Demorado"), varout.mf = object.cls$varout.mf, miu.rule=res.test,
